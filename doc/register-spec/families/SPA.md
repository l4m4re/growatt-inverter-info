...
| I | 2000 | Inverterrunstate | register value | — | R | source_only |
...
| I | 2035 | Outputpower(high) | register value | — | R | source_only |
| I | 2036 | Outputpower(low) | register value | — | R | source_only |
| I | 2037 | Gridfrequency | register value | — | R | source_only |
| I | 2038 | Three/singlephasegridvoltage | register value | — | R | source_only |
| I | 2039 | Three/singlephasegridoutputcurrent | register value | — | R | source_only |
| I | 2040 | Three/single phase grid output watt VA(high) | register value | — | R | source_only |
| I | 2041 | Three/single phase grid output watt VA(low) | register value | — | R | source_only |
...
| I | 2053 | Todaygenerateenergy(high) | register value | — | R | source_only |
| I | 2054 | Todaygenerateenergy(low) | register value | — | R | source_only |
| I | 2055 | Totalgenerateenergy(high) | register value | SPA | R | source_only |
| I | 2056 | Totalgenerateenergy(low) | register value | SPA | R | source_only |
| I | 2057 | Worktimetotal(high) | register value | SPA | R | source_only |
| I | 2058 | Worktimetotal(low) | register value | SPA | R | source_only |
...
| I | 2093 | Invertertemperature | register value | SPA | R | source_only |
| I | 2094 | TheinsideIPMininverterTemperature | register value | SPA | R | source_only |
| I | 2095 | Boosttemperature | register value | SPA | R | source_only |
| I | 2096 | Temp4 | register value | reserved | R | source_only |
| I | 2097 | BatVolt_DSP | register value | BatVolt(DSP) | R | source_only |
| I | 2098 | PBusinsideVoltage | register value | SPA | R | source_only |
| I | 2099 | NBusinsideVoltage | register value | SPA | R | source_only |
| I | 2100 | / | register value | Remote setup enable | R | source_only |
| I | 2101 | / | register value | Remotely setpower | R | source_only |
| I | 2102 | ExtrainverteACPowertogridHigh | register value | SPAused | R | source_only |
| I | 2103 | ExtrainverteACPowertogridLow | register value | SPAused | R | source_only |
| I | 2104 | ExtrainverterPowerTOUser_Extra today(high) | register value | SPA used | R | source_only |
| I | 2105 | ExtrainverterPowerTOUser_Extra today(low) | register value | SPA used | R | source_only |
| I | 2106 | Extrainverter PowerTOUser_Extratotal(high) | register value | SPA used | R | source_only |
| I | 2107 | ExtrainverterPowerTOUser_Extra total(low) | register value | SPA used | R | source_only |
| I | 2108 | SystemelectricenergytodayH | register value | SPA used System electric energy todayH | R | source_only |
| I | 2109 | SystemelectricenergytodayL | register value | SPA used System electric energy todayL | R | source_only |
| I | 2110 | SystemelectricenergytotalH | register value | SPA used System | R | source_only |
| I | 2111 | SystemelectricenergytotalL | register value | — | R | source_only |
| I | 2112 | ACChargeenergytoday | register value | — | R | source_only |
| I | 2113 | ACChargeenergytoday | register value | — | R | source_only |
| I | 2114 | ACChargeenergytotal | register value | — | R | source_only |
| I | 2115 | ACChargeenergytotal | register value | — | R | source_only |
| I | 2116 | Gridpowertolocalload | register value | — | R | source_only |
| I | 2117 | Gridpowertolocalload | register value | — | R | source_only |
| I | 2118 | 0:LoadFirst 1:BatteryFirst 2:GridFirst | register value | — | R | source_only |
| I | 2119 | 0：Lead-acid 1：Lithiumbattery | register value | — | R | source_only |
| I | 2120 | Agingmode | register value | — | R | source_only |
...
### input 1131 — Extra AC Power to grid_H

Semantic: `telemetry.extra_ac_power_to_grid_h`; subsystem: `grid`; measurement point: `grid_meter_or_inverter`.
Vendor names: Extra AC Power to grid_H; evidence: source_documented.
Write policy: `read_only`; native blocks: none.


### input 1132 — Extra AC Power to grid_L

Semantic: `telemetry.extra_ac_power_to_grid_l`; subsystem: `grid`; measurement point: `grid_meter_or_inverter`.
Vendor names: Extra AC Power to grid_L; evidence: source_documented.
Write policy: `read_only`; native blocks: none.


### input 1133 — Eextra_todayH

Semantic: `field.eextra_todayh`; subsystem: `inverter`; measurement point: `inverter`.
Vendor names: Eextra_todayH; evidence: source_documented.
Write policy: `read_only`; native blocks: none.


### input 1134 — Eextra_todayL

Semantic: `field.eextra_todayl`; subsystem: `inverter`; measurement point: `inverter`.
Vendor names: Eextra_todayL; evidence: source_documented.
Write policy: `read_only`; native blocks: none.


### input 1135 — Eextra_totalH

Semantic: `field.eextra_totalh`; subsystem: `inverter`; measurement point: `inverter`.
Vendor names: Eextra_totalH; evidence: source_documented.
Write policy: `read_only`; native blocks: none.


### input 1136 — Eextra_totalL

Semantic: `field.eextra_totall`; subsystem: `inverter`; measurement point: `inverter`.
Vendor names: Eextra_totalL; evidence: source_documented.
Write policy: `read_only`; native blocks: none.


### input 1137 — Esystem_today H

Semantic: `field.esystem_today_h`; subsystem: `unknown`; measurement point: `unknown`.
Vendor names: Esystem_today H; evidence: source_documented.
Write policy: `read_only`; native blocks: none.


### input 1138 — Esystem_ today L

Semantic: `field.esystem_today_l`; subsystem: `unknown`; measurement point: `unknown`.
Vendor names: Esystem_ today L; evidence: source_documented.
Write policy: `read_only`; native blocks: none.


### input 1139 — Esystem_totalH

Semantic: `field.esystem_totalh`; subsystem: `unknown`; measurement point: `unknown`.
Vendor names: Esystem_totalH; evidence: source_documented.
Write policy: `read_only`; native blocks: none.


### input 1140 — Esystem_totalL

Semantic: `field.esystem_totall`; subsystem: `unknown`; measurement point: `unknown`.
Vendor names: Esystem_totalL; evidence: source_documented.
Write policy: `read_only`; native blocks: none.
...
### input 2103 — Extra AC Power to grid_L
...
Semantic: `field.priority`; subsystem: `storage_device`; measurement point: `bdc_or_storage_device`.
Vendor names: Priority; evidence: source_documented.
Write policy: `read_only`; native blocks: none.

Enums: 0=loadfirst_1 (LoadFirst 1); 2=gridfirst (GridFirst)
