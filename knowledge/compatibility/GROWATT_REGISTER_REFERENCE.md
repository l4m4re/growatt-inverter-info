...
> This file is a generated compatibility view. The canonical machine-readable and human reference is `spec/growatt-register-spec.json` plus its Markdown views; the original vendor, runtime, external and live-evidence files remain the provenance corpus.
...
| holding | 3036 | grid_first_discharge_rate | supported | Grid-first discharge power rate | Grid-first discharge power rate | u16 percentage; 255 disables limit | % | R/W | RESOLVED | read_verified, semantic_correlated, source_claim | Vendor V1.24 defines the grid-first discharge power-rate control and the source map corroborates its hybrid TL-XH applicability.; ;  |
| holding | 3037 | grid_first_stop_soc | supported | Grid-first stop SOC | Grid-first stop SOC | u16 percentage | % | R/W | RESOLVED | read_verified, semantic_correlated, source_claim | Vendor V1.24 defines the grid-first stop-SOC control; it is a scalar percentage and not part of the adjacent schedule word.; ;  |
| holding | 3038 | grid_first_schedule_1_start_control | supported | Grid-first schedule 1 start/control | Grid-first schedule 1 start/control | packed u16: minute/hour/priority/enable | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 defines Time1 as one packed schedule word; the adjacent end word is 3039.; ;  |
| holding | 3039 | grid_first_schedule_1_end | supported | Grid-first schedule 1 end | Grid-first schedule 1 end | packed u16: minute/hour | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 defines the end time as the adjacent packed word; no power or energy unit applies.; ;  |
| holding | 3040 | grid_first_schedule_2_start_control | supported | Grid-first schedule 2 start/control | Grid-first schedule 2 start/control | packed u16: minute/hour/priority/enable | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 describes Time2 with the same packed schedule structure as Time1.; ;  |
| holding | 3041 | grid_first_schedule_2_end | supported | Grid-first schedule 2 end | Grid-first schedule 2 end | packed u16: minute/hour | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 describes the adjacent end word as packed time data; the inherited W unit was an unrelated datatype collision.; ;  |
| holding | 3042 | grid_first_schedule_3_start_control | supported | Grid-first schedule 3 start/control | Grid-first schedule 3 start/control | packed u16: minute/hour/priority/enable | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 states that Time3 has the Time1 packed layout.; ;  |
| holding | 3043 | grid_first_schedule_3_end | supported | Grid-first schedule 3 end | Grid-first schedule 3 end | packed u16: minute/hour | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 states that the Time3 end word has the Time1 packed layout.; ;  |
| holding | 3044 | grid_first_schedule_4_start_control | supported | Grid-first schedule 4 start/control | Grid-first schedule 4 start/control | packed u16: minute/hour/priority/enable | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 states that Time4 has the Time1 packed layout.; ;  |
| holding | 3045 | grid_first_schedule_4_end | supported | Grid-first schedule 4 end | Grid-first schedule 4 end | packed u16: minute/hour | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 states that the Time4 end word has the Time1 packed layout.; ;  |
| holding | 3046 | — | unknown | Reserved | Reserved | u16 raw | W | R | RESOLVED | read_verified, source_claim | ;  |
| holding | 3047 | battery_first_charge_rate | supported | Battery-first charge power rate | Battery-first charge power rate | u16 percentage | % | R/W | RESOLVED | read_verified, semantic_correlated, source_claim | Legacy data-type catalogue incorrectly labels this as a two-word runtime counter.; Vendor and implementation evidence agree that H3047 is the battery-first charge-rate control; the conflicting two-word runtime interpretation belongs to input 3047.; ;  |
| holding | 3048 | battery_first_stop_soc | supported | Battery-first stop SOC | Battery-first stop SOC | u16 percentage | % | R/W | RESOLVED | read_verified, semantic_correlated, source_claim | Legacy data-type catalogue incorrectly labels this as the low word of runtime.; Vendor and implementation evidence agree that H3048 is the battery-first stop-SOC control; it is not the low word of input runtime.; ;  |
| holding | 3049 | ac_charge_enabled | supported | AC charge enabled | AC charge enabled | u16 enum 0=disabled, 1=enabled | — | R/W | RESOLVED | read_verified, semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor, HA and retained live evidence identify H3049 as the AC-charge enable control; the adjacent input 3049 is an energy counter.; ;  |
| holding | 3050 | battery_first_schedule_1_start_control | supported | Battery-first schedule 1 start/control | Battery-first schedule 1 start/control | packed u16: minute/hour/priority/enable | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 defines Time5 as one packed schedule word.; ;  |
| holding | 3051 | battery_first_schedule_1_end | supported | Battery-first schedule 1 end | Battery-first schedule 1 end | packed u16: minute/hour | — | R/W | RESOLVED | read_verified, source_claim | The adjacent Time5 end word is packed time data; the inherited kWh unit was a datatype collision.; ;  |
| holding | 3052 | battery_first_schedule_2_start_control | supported | Battery-first schedule 2 start/control | Battery-first schedule 2 start/control | packed u16: minute/hour/priority/enable | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 defines Time6 with the common packed schedule structure.; ;  |
| holding | 3053 | battery_first_schedule_2_end | supported | Battery-first schedule 2 end | Battery-first schedule 2 end | packed u16: minute/hour | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 defines the adjacent end word as packed time data.; ;  |
| holding | 3054 | battery_first_schedule_3_start_control | supported | Battery-first schedule 3 start/control | Battery-first schedule 3 start/control | packed u16: minute/hour/priority/enable | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 defines Time7 with the common packed schedule structure.; ;  |
| holding | 3055 | battery_first_schedule_3_end | supported | Battery-first schedule 3 end | Battery-first schedule 3 end | packed u16: minute/hour | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 defines the adjacent end word as packed time data.; ;  |
| holding | 3056 | battery_first_schedule_4_start_control | supported | Battery-first schedule 4 start/control | Battery-first schedule 4 start/control | packed u16: minute/hour/priority/enable | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 defines Time8 with the common packed schedule structure.; ;  |
| holding | 3057 | battery_first_schedule_4_end | supported | Battery-first schedule 4 end | Battery-first schedule 4 end | packed u16: minute/hour | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 defines the adjacent end word as packed time data.; ;  |
| holding | 3058 | battery_first_schedule_5_start_control | supported | Battery-first schedule 5 start/control | Battery-first schedule 5 start/control | packed u16: minute/hour/priority/enable | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 defines Time9 with the common packed schedule structure.; ;  |
| holding | 3059 | battery_first_schedule_5_end | supported | Battery-first schedule 5 end | Battery-first schedule 5 end | packed u16: minute/hour | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 defines the adjacent end word as packed time data.; ;  |
...
| holding | 3079 | ups_eps_function_enable | supported | UPS/EPS function enable | UPS/EPS function enable | u16 enum 0=disabled, 1=enabled | — | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 identifies H3079 as the UPS/EPS function enable control.; ;  |
| holding | 3080 | ups_eps_voltage_selection | supported | UPS/EPS voltage selection | UPS/EPS voltage selection | u16 enum 0=230 V, 1=208 V, 2=240 V | V | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 identifies H3080 as the UPS/EPS voltage selection control.; ;  |
| holding | 3081 | ups_eps_frequency_selection | supported | UPS/EPS frequency selection | UPS/EPS frequency selection | u16 enum 0=50 Hz, 1=60 Hz | Hz | R/W | RESOLVED | read_verified, source_claim | FC04 3081 is PV4 lifetime-energy high word; FC03 3081 is UPSFreqSet.; Vendor V1.24 identifies H3081 as the UPS/EPS frequency selection control; the input-space I3081 remains PV4 lifetime energy.; ;  |
| holding | 3082 | load_first_stop_soc | supported | Load-first stop SOC | Load-first stop SOC | u16 percentage | % | R/W | RESOLVED | read_verified, source_claim | Vendor V1.24 identifies H3082 as the load-first stop-SOC control. Raw zero observations are retained as observations, not rewritten as a different meaning.; ;  |
...
| input | 110 | inverter_warning_flags_high | supported | Inverter warning bitfield high word | WarningbitH | u16 vendor-defined warning bitfield | — | R | SOURCE_ONLY | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 labels input 110 WarningbitH. The previous two-word Warning code label and /10 scale came from a runtime collision and must not absorb input 111.; ;  |
| input | 111 | inverter_warning_subcode | supported | Inverter warning subcode | Inverterwarnsubcode | u16 vendor-defined warning subcode | — | R | SOURCE_ONLY | source_claim | Vendor V1.24 labels input 111 WarnSubcode as a separate word.; ;  |
...
| input | 3021 | — | unknown | Output reactive power | reactivepower | s32 / 10; /10 | var | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The OpenInverter snapshot uses the symbolic POWER_REACTIVE unit, while the curated map and independent implementation define signed reactive power in 0.1 var. The high word inherits the same logical-field unit as I3022.; ;  |
...
| input | 3071 | grid_export_energy_today | alternate | Grid export energy today | Todayenergytogrid | u32 / 10; /10 | kWh | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor Etogrid_todayH, Grott, curated and OpenInverter evidence identify this as the high word of today's grid-export energy, not instantaneous grid-export power.; ; alternates: register:min_tl_xh:input:3072 |
| input | 3072 | grid_export_energy_today | alternate | Grid export energy today (low word) | Energy exported to the grid today (0.1 kWh resolution). | u32 / 10; /10 | kWh | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor Etogrid_todayL and correlated implementations identify this as the low word paired with I3071; the old power name was a semantic collision.; ; alternates: register:min_tl_xh:input:3071 |
| input | 3073 | grid_export_energy_total | alternate | Grid export energy total | Totalenergytogrid | u32 / 10; /10 | kWh | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor Etogrid_totalH, Grott, curated and OpenInverter evidence identify this as the high word of lifetime grid-export energy, not instantaneous grid-export power.; ; alternates: register:min_tl_xh:input:3074 |
| input | 3074 | grid_export_energy_total | alternate | Grid export energy total (low word) | Lifetime energy exported to the grid (0.1 kWh resolution). | u32 / 10; /10 | kWh | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor Etogrid_totalL and correlated implementations identify this as the low word paired with I3073; the old power name was a semantic collision.; ; alternates: register:min_tl_xh:input:3073 |
...
| input | 3110 | inverter_warning_flags | supported | Inverter warning bitfield | Current inverter warning code (vendor-defined bitmask). | u16 vendor-defined warning bitfield | — | R | SOURCE_ONLY | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The vendor identifies input 3110 only as a bitfield; the old two-word /10 Warning code interpretation is not supported by the retained source.; ;  |
| input | 3111 | inverter_present_fft_value_channel_a | supported | Present FFT value (vendor channel A) | PresentFFTValue[CHANNEL_A] | u16 vendor-defined diagnostic value | — | R | SOURCE_ONLY | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 names input 3111 uwPresentFFTValue[CHANNEL_A]. The source datatype column says bitfield but supplies no bit definitions; retain the word as a raw unsigned numeric diagnostic value, not as an inverter warning code.; ;  |
...
| input | 3164 | bdc_data_separation | supported | BDC data-separation flag | BDC presence flag | u16 enum 0=no separate BDC data, 1=separate BDC data | — | R | RESOLVED_WITH_NOTES | read_verified, semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor text says whether BDC data should be parsed separately, not whether a BDC is physically present. Retained live raw value 0 does not prove a presence state.; ;  |
| input | 3165 | bdc_derating_mode | supported | BDC derating mode | BDCDeratingMode: 0=Normal, unrestricted; 1=Standby or fault; 2=Maximum battery current limit (discharge); 3=Battery discharge enabled; 4=High bus discharge derating; 5=High temperature discharge derating; 6=System warning, no discharge; 16=Maximum charging current; 17=High temperature charging; 18=Final soft charge; 19=SOC setting limits; 20=Battery low temperature; 21=High bus voltage; 22=Battery SOC (charging); 23=Need to charge; 24=System warning, not charging. Values 7-15 and 25-29 are reserved. | u16 enum | — | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The V1.24 vendor description defines the mode values; no live sample is required to establish the documented field identity.; ;  |
| input | 3166 | bdc_system_mode_status | supported | BDC system mode and status | SystemworkStateandmodeThe upper8bitsindicatethemode; 0：Nochargeanddischarge； 1：charge； 2：Discharge； Thelower8bitsrepresentthestatus; 0:StandbyStatus; 1:NormalStatus; 2:FaultStatus 3：FlashStatus; | u16 packed: upper byte mode, lower byte status | — | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; V1.24 explicitly assigns the upper byte to charge/discharge mode and the lower byte to standby/normal/fault/flash status.; ;  |
...
| input | 3176 | — | unknown | Battery temperature A | TempertureA | register value; /10 | °C | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The vendor names BMS temperature A and the retained implementation uses /10 °C, but the corpus does not prove whether the field is pack, module, or channel scoped beyond the vendor label.; ;  |
| input | 3177 | — | unknown | Battery temperature B | TempertureB | register value; /10 | °C | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The vendor names BMS temperature B and the retained implementation uses /10 °C, but the corpus does not prove whether the field is pack, module, or channel scoped beyond the vendor label.; ;  |
...
| input | 3191 | bms_average_temperature_channel_a | supported | BMS average temperature (vendor channel A) | BmsBatteryAvgTemp | u16 temperature; scale not specified by vendor | °C | R | SOURCE_ONLY | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The vendor names the field but supplies no scale; the retained raw zero cannot distinguish /1 from /10. Channel suffix is retained as vendor wording, not a proven pack number.; ;  |
| input | 3192 | — | unknown | BMS max cell temperature A | BmsMaxCellTemp | register value; /10 | °C | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 explicitly gives 0.1 °C resolution for this BMS temperature field. The vendor channel suffix is retained without asserting a separate physical BMS instance.; ;  |
| input | 3193 | — | unknown | BMS average temperature B | BmsBatteryAvgTemp | register value; /10 | °C | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 explicitly gives 0.1 °C resolution for this BMS temperature field. The vendor channel suffix is retained without asserting a separate physical BMS instance.; ;  |
| input | 3194 | bms_max_cell_temperature_channel_b | supported | BMS maximum cell temperature (vendor channel B) | BmsMaxCellTemp | u16 temperature; scale not specified by vendor | °C | R | SOURCE_ONLY | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The vendor names the field but supplies no scale; the retained low raw value is insufficient to choose /1 or /10.; ;  |
| input | 3195 | bms_average_temperature_channel_c | supported | BMS average temperature (vendor channel C) | BmsBatteryAvgTemp | u16 temperature; scale not specified by vendor | °C | R | SOURCE_ONLY | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The vendor names the repeated field but supplies no scale; the retained raw value alone cannot establish its physical resolution or hardware instance.; ;  |
| input | 3196 | bms_max_soc | supported | BMS maximum SOC | BmsMaxSOC | u16 percentage | % | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 names a parallel-maximum-SOC diagnostic distinct from instantaneous BMS SOC; a retained zero is not reinterpreted as the live SOC.; ;  |
| input | 3197 | bms_min_soc | supported | BMS minimum SOC | BmsMinSOC | u16 percentage | % | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 names a parallel-minimum-SOC diagnostic distinct from instantaneous BMS SOC; a retained zero is not reinterpreted as the live SOC.; ;  |
...
| input | 3200 | battery_bms_full_charge_capacity | supported | BMS gauge full-charge capacity | BmsGaugeFCC（Ah） | u16 Ah; scale not specified by vendor | Ah | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor explicitly says GaugeFCC, but does not define numeric resolution. Equality with GaugeRM in one retained sample does not prove either a dynamic capacity meaning or a scale.; ;  |
| input | 3201 | battery_bms_remaining_capacity | supported | BMS gauge remaining capacity | BmsGaugeRM（Ah） | u16 Ah; scale not specified by vendor | Ah | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor explicitly says GaugeRM, but does not define numeric resolution. Equality with GaugeFCC in one retained sample means live remaining-capacity behavior remains unverified.; ;  |
| input | 3202 | — | unknown | BMS protect flags 1 | BMSProtect1 | register value; /1 | — | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 identifies I3202 as a BMS gauge protection flag. The bit meanings are not published, so it remains a raw diagnostic flag rather than a decoded alarm.; ;  |
| input | 3203 | — | unknown | BMS warning flags 1 | BMSWarn1 | register value; /1 | — | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 identifies I3203 as a BMS gauge warning flag. The bit meanings are not published, so it remains a raw diagnostic flag rather than a decoded alarm.; ;  |
| input | 3204 | — | unknown | BMS fault flags 1 | BMSFault1 | register value; /1 | — | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 identifies I3204 as a BMS gauge fault flag. The bit meanings are not published, so it remains a raw diagnostic flag rather than a decoded alarm.; ;  |
| input | 3205 | — | unknown | BMS fault flags 2 | BMSFault2 | register value; /1 | — | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 identifies I3205 as a second BMS gauge fault flag. The bit meanings are not published, so it remains a raw diagnostic flag rather than a decoded alarm.; ;  |
...
| input | 3210 | — | unknown | Battery insulation status | BatteryISOdetectionstatus | u16 enum 0=not detected, 1=detection completed | — | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The vendor enum text was merged into unit; it describes values, not an engineering unit. The canonical field keeps the enum in the datatype/enum layer.; ;  |
...
| input | 3212 | — | unknown | BMS status | BMS status | u16 enum | — | R | RESOLVED_WITH_NOTES | read_verified, semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The documented BMS status enum belongs to enum metadata; the textual value list is not an engineering unit. Existing decoded enum values are retained.; ;  |
...
| input | 3217 | battery_current | alternate | BMS battery current | BMS battery current | s16 / 100; /100 | A | R | RESOLVED | read_verified, semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The retained HA-5 regression and live sample support signed BMS current at 0.01 A resolution; raw 0xFEB6 decodes to -3.30 A. This is distinct from storage-device current I3170.; ; alternates: register:min_tl_xh:input:3170 |
| input | 3218 | — | unknown | BMS max cell temperature | batterycellmaximumtemperature | register value; /10 | °C | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 explicitly gives 0.1 °C resolution for the BMS temperature field; numeric diagnostic semantics beyond that source label remain unexpanded.; ;  |
...
| input | 3221 | battery_bms_cycle_count | supported | BMS cycle count | BMSCycleCnt | u16 cycle count | cycles | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor names BMSCycleCnt, but a retained zero despite substantial throughput does not distinguish unsupported/default behavior from a genuine zero counter.; ;  |
| input | 3222 | battery_bms_soh | supported | BMS state of health | BMS SOH | u16 percentage | % | R | RESOLVED_WITH_NOTES | read_verified, semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor and independent implementations identify BMS SOH as a percentage; a live value of 100 is value evidence, not behavioral validation of the estimator.; ;  |
...
| input | 3224 | battery_bms_discharge_voltage_limit | supported | BMS discharge voltage limit | Batterydischargevoltagelimitvalue | u16 / 100; /100 | V | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; The vendor leaves this row's scale blank, but the adjacent charge limit is /100 and the retained raw 18880 is physically plausible as 188.80 V; keep the claim below vendor-proven status.; ;  |
| input | 3225 | — | unknown | BMS warning flags 3 | BMSWarn3 | register value; /1 | — | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 identifies I3225 as a BMS warning-3 flag. The flag bits are not decoded without an independent codebook.; ;  |
| input | 3226 | — | unknown | BMS protect flags 3 | BMSProtect3 | register value; /1 | — | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 identifies I3226 as a BMS protection-3 flag. The flag bits are not decoded without an independent codebook.; ;  |
...
| input | 3230 | battery_bms_max_cell_voltage | supported | BMS maximum cell voltage | BMSBatterySingleVoltMax | u16 / 1000; /1000 | V | R | RESOLVED | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 explicitly specifies 0.001 V; retained raw 3314 decodes to 3.314 V, so frontend rounding must not change the canonical scale.; ;  |
| input | 3231 | battery_bms_min_cell_voltage | supported | BMS minimum cell voltage | BMSBatterySingleVoltMin | u16 / 1000; /1000 | V | R | RESOLVED | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 explicitly specifies 0.001 V; retained raw 3311 decodes to 3.311 V, so frontend rounding must not change the canonical scale.; ;  |
| input | 3232 | battery_load_voltage | supported | Battery load voltage | BatteryLoadVolt | u16 / 100; /100 | V | R | RESOLVED_WITH_NOTES | semantic_correlated, source_claim | Vendor BatLoadVolt places [0,650.00] in the range/value column and gives 0.01 V resolution. The curated source supplies V; the range text must not become the canonical unit.; ;  |
...
| input | 3280 | — | unknown | Clear current-day data flag | Cleardaydataflag | u16 vendor-defined flag | — | R | SOURCE_ONLY | source_claim | The vendor sentence 'Data of the current day that the server' is descriptive text that entered the unit column. It is retained as provenance, while the canonical unit is empty because the bit semantics are not fully documented.; ;  |
...
Original evidence files are retained under `sources/`; this generated reference is the recommended compatibility lookup.
