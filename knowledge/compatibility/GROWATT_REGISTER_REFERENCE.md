...
| input | 3111 | inverter_present_fft_value_channel_a | supported | Present FFT value (vendor channel A) | PresentFFTValue[CHANNEL_A] | u16 vendor-defined diagnostic value | — | R | SOURCE_ONLY | semantic_correlated, source_claim | Source datatype catalogue contains conflicting or incomplete fields; the selected interpretation is retained with alternatives.; Vendor V1.24 names input 3111 uwPresentFFTValue[CHANNEL_A]; it is not established as an inverter warning code.; ;  |
