...
CANONICAL_PATH = DOC_DIR / "knowledge" / "audit" / "consolidated-register-reference.json"
MIN_MAP_PATH = DOC_DIR / "sources" / "evidence" / "min-6000tl-xh-register-map.json"
MIN_LIVE_PATH = DOC_DIR / "sources" / "evidence" / "min-6000tl-xh-live-validation.json"
...
SOURCE_DEFINITIONS: dict[str, dict[str, Any]] = {
    "vendor_v124": {
        ...
        "path": "sources/vendor/growatt-v1.24-tables.json",
        "independent": True,
    },
    "curated_best_guess": {
        "label": "curated best-guess/spec interpretation",
        "kind": "curated_interpretation",
        "path": "sources/curated/growatt-registers-best-guess.json",
        "independent": False,
    },
    "ha_runtime": {
        "label": "Home Assistant runtime register snapshot",
        "kind": "runtime_implementation",
        "path": "sources/runtime/ha-local-registers.snapshot.json",
        "independent": True,
    },
    "openinverter_gateway": {
        "label": "OpenInverterGateway mapping",
        "kind": "external_implementation",
        "path": "sources/external/openinverter-gateway-registers.snapshot.json",
        "independent": True,
    },
    "inverter_to_mqtt": {
        "label": "inverter-to-MQTT mapping",
        "kind": "external_implementation",
        "path": "sources/external/inverter-to-mqtt-registers.snapshot.json",
        "independent": True,
    },
    "grott": {
        "label": "Grott decoded layout",
        "kind": "external_implementation",
        "path": "sources/external/grott-register-layouts.snapshot.json",
        "independent": True,
    },
    "manual": {
        "label": "curated/manual datatype annotation",
        "kind": "curated_interpretation",
        "path": "tools/build_register_data_types.py",
        "independent": False,
    },
    "min_resolved_map": {
        "label": "MIN 6000TL-XH resolved model map",
        "kind": "model_specific_resolved_overlay",
        "path": "sources/evidence/min-6000tl-xh-register-map.json",
        "independent": False,
    },
    "min_live_validation": {
        "label": "MIN 6000TL-XH live read validation",
        "kind": "live_hardware_evidence",
        "path": "sources/evidence/min-6000tl-xh-live-validation.json",
        "independent": True,
    },
    ...
    "ha5_regression_tests": {
        ...
        "path": "tests/test_resolved_register_reference.py",
        "independent": False,
    },
    "graph_export": {
        "label": "graph-derived consolidated export",
        "kind": "generated_derivative",
        "path": "knowledge/audit/consolidated-register-reference.json",
        "independent": False,
        "derived": True,
    },
}
...
def build_reference() -> dict[str, Any]:
    ...
    return {
        "meta": {
            ...
            "canonical_reference": "spec/growatt-register-spec.json",
