...
MAPPING_PATH = REPO_ROOT / "sources" / "runtime" / "ha-local-registers.snapshot.json"
OUTPUT_PATH = REPO_ROOT / "sources" / "curated" / "growatt-register-data-types.json"
...
MANUAL_TYPES: dict[str, dict[str, Any]] = {
    ...
    "ups_function_enable": {
        ...
        "unit": "bool",
        "read_write": True,
        "values": {"0": {"label": "disabled"}, "1": {"label": "enabled"}},
    },
    "ups_voltage_selection": {
        "kind": "enum",
        "registers": 1,
        "bits": 16,
        "unit": "V",
    ...
    "ups_frequency_selection": {
        "kind": "enum",
        "registers": 1,
        "bits": 16,
        "unit": "Hz",
        "read_write": True,
        "values": {"0": {"label": "50Hz"}, "1": {"label": "60Hz"}},
    },
