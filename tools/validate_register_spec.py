...
def validate(spec: dict) -> None:
    ...
    compatibility_path = DOC_DIR / "knowledge" / "compatibility" / "growatt-register-reference.json"
    if compatibility_path.is_file():
        ...
        if (
            ...
            or metadata.get("canonical_reference") != "spec/growatt-register-spec.json"
        ):
