...
VENDOR_TABLE_PATH = DOC_DIR / "vendor" / "growatt-v1.24-tables.json"
...
VENDOR_MANUAL_PDF_PATH = DOC_DIR / "vendor" / "Growatt-Inverter-Modbus-RTU-Protocol_II-V1_24-English.pdf"

DEFAULT_OUTPUT = PROJECT_ROOT / "knowledge" / "graph" / "register-graph.gpickle"
...
def ingest_manual_datatypes(graph: nx.MultiDiGraph) -> None:
    ...
    source_id = add_source_document(
        ...
        PROJECT_ROOT / "tools" / "build_register_data_types.py",
    )
