...
This is the retained HA-6D source manifest. Paths in the historical notes
below refer to the former HA checkout; the extracted product paths are listed
in `sources/manifest.json` and the repository README.
