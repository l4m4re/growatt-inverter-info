...
`v124-instruction-storage-spa`: Storage (SPA Type): 03 register range: 0~124, 1000~1124; 04 register range: 1000~1124, 2000~2124, 1125~1249

| Applicability path | Resolved block |
| --- | --- |
| v124-holding-p009-first_group-block-01:v124-instruction-storage-spa:holding:0:124:3 | declared/no semantic block |
| v124-holding-p027-six_group_for_storage_power-block-03:v124-instruction-storage-spa:holding:1000:1124:3 | declared/no semantic block |
| v124-input-p059-ninth_group_for_storage_power-block-10:v124-instruction-storage-spa:input:1000:1124:4 | declared/no semantic block |
| v124-input-p062-bms_infomation-block-11:v124-instruction-storage-spa:input:1000:1124:4 | declared/no semantic block |
| v124-input-p062-ups_information_offline-block-12:v124-instruction-storage-spa:input:1000:1124:4 | declared/no semantic block |
| v124-input-p064-ninth_group_reserved_for_storage_power-block-13:v124-instruction-storage-spa:input:1125:1249:4 | declared/no semantic block |
| v124-input-p064-ninth_group_reserved_for_storage_power-block-13:v124-instruction-storage-spa:input:2000:2124:4 | declared/no semantic block |

Block projections: `cb-holding-p009-first_group-block-01`, `cb-holding-p027-six_group_for_storage_power-block-03`, `cb-input-p059-ninth_group_for_storage_power-block-10`, `cb-input-p062-bms_infomation-block-11`, `cb-input-p062-ups_information_offline-block-12`, `cb-input-p064-ninth_group_reserved_for_storage_power-block-13`. Register rows below are references to shared block definitions; applicability does not duplicate them.
...
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1125 | input | 1125 | control.accharge_energytodayl | ACCharge EnergyTodayH (low word) | write |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1126 | input | 1126 | telemetry.a1ccharge_energytotalh | A1CCharge EnergyTotalH | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1127 | input | 1127 | telemetry.accharge_energytotall | ACCharge EnergyTotalL | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1128 | input | 1128 | control.ac_charge_power_h | AC Charge Power H (high word) | write |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1129 | input | 1129 | control.ac_charge_powerl | AC Charge Power H (low word) | write |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1130 | input | 1130 | control.70_inv_power_adjust | 70% INV Power adjust | write |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1131 | input | 1131 | telemetry.extra_ac_power_to_grid_h | Extra AC Power to grid_H (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1132 | input | 1132 | telemetry.extra_ac_power_to_grid_l | Extra AC Power to grid_H (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1133 | input | 1133 | field.eextra_todayh | Eextra_todayH (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1134 | input | 1134 | field.eextra_todayl | Eextra_todayH (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1135 | input | 1135 | field.eextra_totalh | Eextra_totalH (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1136 | input | 1136 | field.eextra_totall | Eextra_totalH (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1137 | input | 1137 | field.esystem_today_h | Esystem_today H (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1138 | input | 1138 | field.esystem_today_l | Esystem_today H (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1139 | input | 1139 | field.esystem_totalh | Esystem_totalH (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1140 | input | 1140 | field.esystem_totall | Esystem_totalH (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1141 | input | 1141 | field.eself_todayh | Eself_todayH (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1142 | input | 1142 | field.eself_todayl | Eself_todayH (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1143 | input | 1143 | field.eself_totalh | Eself_totalH (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1144 | input | 1144 | field.eself_totall | Eself_totalH (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1145 | input | 1145 | field.psystemh | PSystemH (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1146 | input | 1146 | field.psysteml | PSystemH (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1147 | input | 1147 | field.pselfh | PSelfH (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1148 | input | 1148 | field.pselfl | PSelfH (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1149 | input | 1149 | field.epvall_todayh | EPVAll_TodayH (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1150 | input | 1150 | field.epvall_todayl | EPVAll_TodayH (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1151 | input | 1151 | field.acdischarge_packsn | AcDischarge PackSn | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1152 | input | 1152 | telemetry.accdischarge_power_h | Accdischarge power_H (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1153 | input | 1153 | telemetry.accdischarge_power_l | Accdischarge power_H (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1154 | input | 1154 | field.acccharge_packsn | AccCharge PackSn | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1155 | input | 1155 | telemetry.acccharge_power_h | AccCharge power_H (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1156 | input | 1156 | telemetry.acccharge_power_l | AccCharge power_H (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1157 | input | 1157 | diagnostic.firstbattfaultsn | FirstBattFaultSn | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1158 | input | 1158 | diagnostic.second_battfaultsn | Second BattFaultSn | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1159 | input | 1159 | diagnostic.third_battfaultsn | Third BattFaultSn | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1160 | input | 1160 | diagnostic.fourth_battfaultsn | Fourth BattFaultSn | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1161 | input | 1161 | diagnostic.batteryhistory_faultcode1 | Batteryhistory faultcode1 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1162 | input | 1162 | diagnostic.batteryhistory_faultcode2 | Batteryhistory faultcode2 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1163 | input | 1163 | diagnostic.batteryhistory_faultcode3 | Batteryhistory faultcode3 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1164 | input | 1164 | diagnostic.batteryhistory_faultcode4 | Batteryhistory faultcode4 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1165 | input | 1165 | diagnostic.batteryhistory_faultcode5 | Batteryhistory faultcode5 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1166 | input | 1166 | diagnostic.batteryhistory_faultcode6 | Batteryhistory faultcode6 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1167 | input | 1167 | diagnostic.batteryhistory_faultcode7 | Batteryhistory faultcode7 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1168 | input | 1168 | diagnostic.batteryhistory_faultcode8 | Batteryhistory faultcode8 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1169 | input | 1169 | battery.number_of_battery_codes | Number of battery codes | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1170 | input | 1170 |  | Register 1170 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1199 | input | 1199 | telemetry.newepowercalc_flag | NewEPowerCalc Flag | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1200 | input | 1200 | battery.maxcellvolt | MaxCellVolt | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1201 | input | 1201 | battery.mincellvolt | MinCellVolt | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1202 | input | 1202 | field.modulenum | ModuleNum | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1203 | input | 1203 | battery.totalcellnum | TotalCellNum | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1204 | input | 1204 | battery.maxvoltcellno | MaxVoltCellNo | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1205 | input | 1205 | battery.minvoltcellno | MinVoltCellNo | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1206 | input | 1206 | battery.maxtemprcell_10t | MaxTemprCell_ 10T | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1207 | input | 1207 | battery.mintemprcell_1_0t | MinTemprCell_1 0T | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1208 | input | 1208 | battery.maxtemprcelln_o | MaxTemprCellN o | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1209 | input | 1209 | battery.mintemprcelln_o | MinTemprCellN o | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1210 | input | 1210 | field.protectpackid | ProtectPackID | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1211 | input | 1211 | battery.maxsoc | MaxSOC | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1212 | input | 1212 | battery.minsoc | MinSOC | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1213 | input | 1213 | field.batprotect1add | BatProtect1Add | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1214 | input | 1214 | field.batprotect2add | BatProtect2Add | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1215 | input | 1215 | diagnostic.batwarn1add | BatWarn1Add | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1216 | input | 1216 | battery.bms_highestsof_tversion | BMS_HighestSof tVersion | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1217 | input | 1217 | battery.bms_hardware_version | BMS_Hardware Version | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1218 | input | 1218 | battery.bms_requestty_pe | BMS_RequestTy pe | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1248 | input | 1248 | field.bkeyagingtesto_kflag | bKeyAgingTestO kFlag | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:1249 | input | 1249 | field.unknown | / | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2000 | input | 2000 | diagnostic.inverterstatus | InverterStatus | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2035 | input | 2035 | field.pach | PacH | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2036 | input | 2036 | field.pacl | PacL | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2037 | input | 2037 | field.fac | Fac | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2038 | input | 2038 | field.vac1 | Vac1 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2039 | input | 2039 | field.iac1 | Iac1 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2040 | input | 2040 | field.pac1h | Pac1H | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2041 | input | 2041 | field.pac1l | Pac1L | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2053 | input | 2053 | field.eactodayh | EactodayH | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2054 | input | 2054 | field.eactodayl | EactodayL | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2055 | input | 2055 | field.eactotalh | EactotalH (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2056 | input | 2056 | field.eactotall | EactotalH (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2057 | input | 2057 | field.timetotalh | TimetotalH (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2058 | input | 2058 | field.timetotall | TimetotalH (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2093 | input | 2093 | field.temp1 | Temp1 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2094 | input | 2094 | field.temp2 | Temp2 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2095 | input | 2095 | field.temp3 | Temp3 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2096 | input | 2096 | field.temp4 | Temp4 | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2097 | input | 2097 | field.uwbatvolt_dsp | uwBatVolt_DSP | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2098 | input | 2098 | telemetry.pbusvoltage | PBusVoltage | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2099 | input | 2099 | telemetry.nbusvoltage | NBusVoltage | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2100 | input | 2100 | field.remotectrlen | RemoteCtrlEn | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2101 | input | 2101 | field.remotectrlpow_er | RemoteCtrlPow er | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2102 | input | 2102 | telemetry.extra_ac_power_to_grid_h | Extra AC Power to grid_H | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2103 | input | 2103 | telemetry.extra_ac_power_to_grid_l | Extra AC Power to grid_L | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2104 | input | 2104 | field.eextra_todayh | Eextra_todayH | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2105 | input | 2105 | field.eextra_todayl | Eextra_todayL | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2106 | input | 2106 | field.eextra_totalh | Eextra_totalH | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2107 | input | 2107 | field.eextra_totall | Eextra_totalL | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2108 | input | 2108 | field.esystem_today_h | Esystem_today H | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2109 | input | 2109 | field.esystem_today_l | Esystem_ today L | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2110 | input | 2110 | field.esystem_totalh | Esystem_totalH | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2111 | input | 2111 | field.esystem_totall | Esystem_totalL | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2112 | input | 2112 | field.eacharge_today_h | EACharge_Today _H (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2113 | input | 2113 | field.eacharge_today_l | EACharge_Today _H (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2114 | input | 2114 | field.eacharge_total_h | EACharge_Total _H (high word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2115 | input | 2115 | field.eacharge_total_l | EACharge_Total _H (low word) | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2116 | input | 2116 | telemetry.ac_charge_power_h | AC charge Power_H | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2117 | input | 2117 | telemetry.ac_charge_power_l | AC charge Power_L | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2118 | input | 2118 | field.priority | Priority | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2119 | input | 2119 | battery.type | Battery type | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2120 | input | 2120 | field.autoproofreadc_md | AutoProofreadC MD | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:2124 | input | 2124 |  | reserved | read |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:row:067-1139 | input | None |  | /                    / |  |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:row:068-1160 | input | None |  | /                    / |  |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:row:068-1164 | input | None |  | reversed |  |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:row:068-1172 | input | None |  | reversed |  |
| cb-input-p064-ninth_group_reserved_for_storage_power-block-13:input:row:069-1179 | input | None |  | reversed |  |
