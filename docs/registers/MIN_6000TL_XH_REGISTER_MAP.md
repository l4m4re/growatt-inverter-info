...
6000TL-XH (one live validation unit). It is intentionally table-specific: FC03 holding
...
| FC | Registers | Result |
|---|---:|---|
| FC03 | 0–29 | identity/configuration block; serial words 23–27 decode to the inverter serial |
