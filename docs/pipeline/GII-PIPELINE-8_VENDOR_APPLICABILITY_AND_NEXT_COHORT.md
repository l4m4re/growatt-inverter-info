...
- Current merged `main`: `044917bd6fd699eddfc9cf76e38fe14f3ae23bab`; canonical SHA-256: `e692d646e34040af999ba4854f65803e4218e184d9e04f2982c06d60782ee405` before and after.
- Canonical records: 4048; canonical unchanged: `false`.
...
The page-3 instruction block is retained as 33 range claims across: `min_tl_xh`, `mod_tl3_xh`, `storage_mix`, `storage_spa`, `storage_sph`, `tl3_max_mid_mac`. Function code/table and start/end are structured, so applicability queries do not depend on ranking code.
...
| 2 | Remaining MIN/TL-XH input 3000-3249 | 250 | 3175 | 1166 | medium | 760 | high |
| 3 | Remaining MIN/TL-XH holding 3000-3124 | 95 | 1195 | 367 | medium | 284 | high |
| 4 | MIN/TL-XH holding 3125-3249 | 125 | 1504 | 48 | low | 161 | high |
| 5 | MIN/TL-XH input 3250-3374 | 125 | 1314 | 94 | low | 148 | high |

### Selected evidence dimensions

| Register | Applicability | Semantic row | Enum/packed | Access | Qualifier | Write docs | Live write |
| --- | --- | --- | --- | --- | --- | --- | --- |
| H3070 | supported | supported | supported | supported | not_present | documented | absent |
| H3071 | supported | supported | supported | supported | present | documented | absent |
| H3095 | supported | supported | supported | supported | not_present | documented | absent |
